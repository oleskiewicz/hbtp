.. todo::
  ...
  - redesign :func:`src.tree.build` to support this (might run out of memory
    in a heap otherwise)

    - see ``my_list_len_v2`` from https://www.southampton.ac.uk/~fangohr/software/ocamltutorial/lecture4.html
